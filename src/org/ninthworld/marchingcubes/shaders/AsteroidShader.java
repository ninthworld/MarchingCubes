 ...
 */
public class AsteroidShader extends AbstractShader {

    private static final String VERTEX_FILE = "/shaders/asteroid/asteroid.vert";
    private static final String FRAGMENT_FILE = "/shaders/asteroid/asteroid.frag";
