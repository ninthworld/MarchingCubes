 ...
 */
public class SpaceShipShader extends AbstractShader {

    private static final String VERTEX_FILE = "/shaders/spaceship/spaceship.vert";
    private static final String FRAGMENT_FILE = "/shaders/spaceship/spaceship.frag";
